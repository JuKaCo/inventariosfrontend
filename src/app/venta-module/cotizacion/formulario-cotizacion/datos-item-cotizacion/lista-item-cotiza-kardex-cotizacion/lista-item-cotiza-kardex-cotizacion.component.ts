...
@Component({
  selector: 'app-lista-item-cotiza-kardex-cotizacion',
  templateUrl: './lista-item-cotiza-kardex-cotizacion.component.html',
  styleUrls: ['./lista-item-cotiza-kardex-cotizacion.component.scss']
})
export class ListaItemCotizaKardexCotizacionComponent implements OnChanges, OnInit {
  //datos generales
